...
def copy_fonts(fonts_dir: str):
    ...
    print(f'- Copied fonts to {FONTS_TROLLTECH_DIR}')
...
def combine_translations(version: str):
    ...
    combined_text = f'''<?xml version="1.0" encoding="utf-8"?>
<!DOCTYPE TS>
...
def generate_tgz(version: str, include: list):
    ...
    print('Created dist/KoboRoot.tgz successfully!')
...
def main():
    ...
    if not re.match(r'\d{8}', version):
        print('Error: Version must have "YYYYMMDD" format')
        return
